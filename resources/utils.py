...
# --- Kodi modules ---
# FileName class uses xbmcvfs.translatePath()
import html.parser
...
class FileName:
    ...
    def __add__(self, other):
        ...
        if type(other) is FileName:
            other_path = other.originalPath
        elif type(other) is bytes:
            other_path = other
        elif type(other) is str:
            other_path = other.decode('utf-8')
        else:
            raise NameError('Unknown type for overloaded + in FileName object')
